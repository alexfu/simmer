  ...
  return (
    <div className={`relative ${className}`}>
      <input
        ...
        required={required}
        className={`w-full rounded-md border px-3 py-2.5 text-sm text-foreground placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-primary/30 ${inputClassName} ${
          isInvalid && isFocused
