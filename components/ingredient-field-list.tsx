      ...
      {ingredients.map((row, index) => (
        <div key={index} className="flex gap-2">
          ...
          <input
            ...
            required
            className="w-20 rounded-md border border-border bg-surface px-3 py-2 text-sm text-foreground placeholder:text-muted focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30"
          />
          <input
            type="text"
